...
$MESSAGE['register']['fields']['gender'] = 'Genere del personaggio';
...
$MESSAGE['logout']['logbackin'] = 'Per rientrare nel gioco tornare alla';
...
$MESSAGE['interface']['sheet']['last_login'] = 'Ultimo login';
...
$MESSAGE['interface']['sheet']['modify_form']['admin']['background'] = 'Background';
$MESSAGE['interface']['sheet']['modify_form']['admin']['relationships'] = 'Affetti';
$MESSAGE['interface']['sheet']['modify_form']['admin']['url_media'] = 'Indirizzo media';
$MESSAGE['interface']['sheet']['modify_form']['admin']['bank'] = 'Denaro in banca';
$MESSAGE['interface']['sheet']['modify_form']['admin']['max_hp'] = 'Salute massima';
$MESSAGE['interface']['sheet']['items']['zaino'] = 'Zaino';
$MESSAGE['interface']['sheet']['items']['list']['item'] = 'Oggetto';
$MESSAGE['interface']['sheet']['items']['list']['pts'] = 'Quantità';
$MESSAGE['interface']['sheet']['items']['list']['charges'] = 'Cariche';
$MESSAGE['interface']['sheet']['items']['list']['stats']['bonus'] = 'Bonus';
...
$MESSAGE['interface']['sheet']['items']['list']['drop'] = 'Abbandona';
$MESSAGE['interface']['sheet']['items']['list']['wield'] = 'Impugna';
$MESSAGE['interface']['sheet']['items']['list']['put_away'] = 'Inventario';
$MESSAGE['interface']['sheet']['items']['list']['put_in'] = 'Zaino';
...
$MESSAGE['interface']['forums']['type'][4] = 'Solo master';
$MESSAGE['interface']['forums']['type'][5] = 'Solo moderatori';
/*Servizi bancari*/
...
$MESSAGE['interface']['bank']['withdraw_no'] = 'Non hai abbastanza denaro sul tuo conto.';
$MESSAGE['interface']['bank']['payment'] = 'Bonifico';
$MESSAGE['interface']['bank']['pay'] = 'Stipendio';
$MESSAGE['interface']['bank']['amount'] = 'Saldo';
$MESSAGE['interface']['bank']['pocket'] = 'In tasca';
$MESSAGE['interface']['bank']['per_day'] = 'Introiti giornalieri';
$MESSAGE['interface']['bank']['cause'] = 'Causale';
$MESSAGE['interface']['bank']['payee'] = 'Beneficiario';
$MESSAGE['interface']['bank']['credit'] = 'Accredito';
...
$MESSAGE['interface']['job']['submit']['quit'] = 'Dimissioni';
$MESSAGE['interface']['job']['ok_job'] = 'Assunzione avvenuta.';
$MESSAGE['interface']['job']['ok_quit'] = 'Dimissione avvenuita.';
$MESSAGE['interface']['job']['job'] = 'Impiego';
$MESSAGE['interface']['job']['pay'] = 'Paga';
...
$MESSAGE['interface']['guilds']['roles_title']['plur'] = 'Profili';
$MESSAGE['interface']['guilds']['roles_title']['sing'] = 'Profilo';
$MESSAGE['interface']['guilds']['pay'] = 'Stipendio';
$MESSAGE['interface']['guilds']['members'] = 'Affiliati';
$MESSAGE['interface']['guilds']['member'] = 'Affiliato';
/*Amministrazione gilde*/
$MESSAGE['interface']['adm_guilds']['page_name'] = 'Amministrazione';
$MESSAGE['interface']['adm_guilds']['back'] = 'Torna al pannello';
$MESSAGE['interface']['adm_guilds']['no_adm'] = 'Non hai i permessi per amministrare una';
$MESSAGE['interface']['adm_guilds']['freelance'] = 'Indipendente';
$MESSAGE['interface']['adm_guilds']['new_member'] = 'Nomina nuovi';
$MESSAGE['interface']['adm_guilds']['fire_member'] = 'Espelli';
$MESSAGE['interface']['adm_guilds']['hire'] = 'Assumi';
$MESSAGE['interface']['adm_guilds']['fire'] = 'Licenzia';
$MESSAGE['interface']['adm_guilds']['quit'] = 'Dimissioni';
$MESSAGE['interface']['adm_guilds']['ok_fire'] = 'Licenziamento avvenuto';
$MESSAGE['interface']['adm_guilds']['cannot_hire'] = 'ha già il massimo numero di affiliazioni consentito, operare prima un licenziamento.';
$MESSAGE['interface']['adm_guilds']['ok_hire'] = 'Assunzione avvenuta';
$MESSAGE['interface']['adm-guilds']['message_body']['fire'] = 'Siamo spiacenti di informati che ti è stata tolta la seguenta carica:';
$MESSAGE['interface']['adm-guilds']['message_body']['hire'] = 'Siamo felici di informati che ti è stata conferita la seguenta carica:';
/*Mercato*/
$MESSAGE['interface']['market']['page_name'] = 'Mercato';
$MESSAGE['interface']['market']['back'] = 'Torna alle categorie';
$MESSAGE['interface']['market']['categories'] = 'Settore';
...
$MESSAGE['interface']['market']['stock'] = 'Quantità';
...
$MESSAGE['interface']['administration']['items']['fit_in']['bag'] = 'Zaino';
...
$MESSAGE['interface']['administration']['items']['fit_in']['ring'] = 'Dito';
...
$MESSAGE['interface']['administration']['locations']['image_button_hover_info'] = 'L\'immagine viene mostrata al posto della prima quando vi si passa su di essa col mouse (il percorso delle immagini è themes/' . $PARAMETERS['themes']['current_theme'] . '/imgs/maps/). Opzione facoltativa: se si inserisce il primo link non è obbligatorio inserire anche questo.';
...
$MESSAGE['interface']['administration']['guilds']['warning']['suppressed'] = 'Siamo spiacenti, ma la gilda di cui facevi parte è stata chiusa.';
...
$MESSAGE['interface']['administration']['guilds']['type_err'] = 'Non è stato specificato alcun tipo per le gilde.';
$MESSAGE['interface']['administration']['guilds']['visible'] = 'Visibile';
$MESSAGE['interface']['administration']['guilds']['role']['page_name'] = "Ruoli della gilda";
$MESSAGE['interface']['administration']['guilds']['role']['name_new'] = "Nuovo ruolo";
$MESSAGE['interface']['administration']['guilds']['role']['name'] = "Ruolo";
$MESSAGE['interface']['administration']['guilds']['role']['pay'] = "Stipendio";
$MESSAGE['interface']['administration']['guilds']['role']['head'] = "Controlli di gilda";
...
/*Cambio nome*/
$MESSAGE['interface']['user']['name']['page_name'] = 'Cambio nome account';
...
$MESSAGE['interface']['user']['name']['force'] = 'Cambia nome ad un account';
...
/*Statistiche*/
$MESSAGE['interface']['user']['stats']['page_name'] = "Statistiche del sito";
...
$MESSAGE['status_pg']['exausted'] = 'Non puoi compiere quest\'azione, la tua salute è troppo bassa.';
$MESSAGE['status_pg']['availability'][0] = 'Non disponibile a giocare';
$MESSAGE['status_pg']['availability'][1] = 'Disponibile a giocare';
...
$MESSAGE['status_pg']['invisible'][1] = 'Invisibile';
...
$MESSAGE['chat']['commands']['skills'] = 'Usa abilità';
$MESSAGE['chat']['commands']['stats'] = 'Usa caratteristica';
